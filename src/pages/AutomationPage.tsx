      ...
      await api.enqueue({
        ...
        prompt: isInternship
          ...
          : isHealth
            ...
            : `Run a complete evidence-based postdoctoral opportunity search for Hongbo Miao using the imported local profile. Search request: ${query}. Verify current primary sources, apply the career-level gate, score fit conservatively, deduplicate by source opportunity and independent contact target, then prepare no more than five complete reviewable material packages. Do not send email or submit applications.`,
      });
      onCreated();
